...
| **DentalSegmentator** | Apache-2.0 (Slicer module) | `Dataset111_453CT_v100.zip`, **Zenodo DOI 10.5281/zenodo.10829674** | ⛔ **Verify the Zenodo record's license before bundling any exported ONNX.** Not implied by the Apache-2.0 source. |
